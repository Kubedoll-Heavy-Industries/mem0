...
from app.models import AccessControl, App, Category, Memory, MemoryState, MemoryStatusHistory, User, memory_categories
...
def _export_logical_memories_gz(
    db: Session, *, user_id: str, app_id: UUID | None = None, from_date: int | None = None, to_date: int | None = None
) -> bytes:
    """
